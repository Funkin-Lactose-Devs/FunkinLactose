...
class LuaHandler {
	public static var Function_Stop:Dynamic = "##LACTOSELUA_FUNCTIONSTOP";
	public static var Function_Continue:Dynamic = "##LACTOSELUA_FUNCTIONCONTINUE";
	public static var Function_StopLua:Dynamic = "##LACTOSELUA_FUNCTIONSTOPLUA";
