...
class Main extends Sprite
{
	...
	*/
	...
	function onCrash(e:UncaughtErrorEvent):Void
	{
		...
		path = "./lactoseCrash/Lactose" + dateNow + ".txt";
		...
		errMsg += "\nUncaught Error: " + e.error + "\nPlease report this error to the GitHub page: https://discord.gg/KTgNZ29s46\n\n> Crash Handler written by: sqirra-rng";

		if (!FileSystem.exists("./lactoseCrash/"))
			FileSystem.createDirectory("./lactoseCrash/");
